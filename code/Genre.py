...
# Step 2: Split the genres column, assuming genres are separated by commas
...
# Step 6: Save the sorted DataFrame to a new CSV file
genre_freq_df.to_csv('artifacts/genre_frequency.csv', index=False)

print("Genre frequency saved to artifacts/genre_frequency.csv in descending order.")
